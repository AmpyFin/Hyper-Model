...
ROCR100 = 100 · price / prevPrice  (period 10)

Features
--------
* **ROCR100 / 100**   (normalised)
* **ROCR100 Slope**
* **Price ROC-3**
"""
...
class ROCR100_Agent:
    ...
    def _feat(self,df):
        c=df["close"]; rocr100=100*c/c.shift(self.n)
        d=df.copy(); d["rocr"]=rocr100/100.0
        d["slope"]=d["rocr"].diff()
    ...
    def fit(self,df):
        d=self._feat(df)
        if len(d)<self.n+10: raise ValueError("Not enough rows for ROCR100_Agent")
